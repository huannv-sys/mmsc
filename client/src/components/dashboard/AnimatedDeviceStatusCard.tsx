...
import {
  useMicroAnimation,
  useMicroAnimationObject,
} from "@/hooks/useMicroAnimation";
...
export const AnimatedDeviceStatusCard: React.FC<
  AnimatedDeviceStatusCardProps
> = ({
  deviceId,
  deviceName,
  deviceType,
  ...
  useEffect(() => {
    if (
      lastMessage &&
      lastMessage.type === "device_status" &&
    ...
    >
      ...
      <CardContent className="p-4 bg-slate-900">
          ...
          <div className="bg-slate-800 p-3 rounded-md">
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-sm font-semibold">
                {Math.round(animatedCpu)}%
              </span>
            </div>
            <Progress
              value={animatedCpu}
              className={cn(
                "h-2 mt-1 transition-all",
                getCpuColor(animatedCpu),
              )}
            />
          </div>
        ...
        <div className="grid grid-cols-3 xs:grid-cols-2 gap-x-4 gap-y-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm">
                {Math.round(animatedExtras.temperature)}°C
              </span>
            </div>
          </div>
          ...
          {deviceStats.signalStrength !== undefined &&
            getSignalStrength(animatedExtras.signalStrength)}
          ...
          {deviceStats.connectedClients !== undefined && (
            <div className="flex flex-col">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm">
                  {Math.round(animatedExtras.connectedClients)}
                </span>
              </div>
            </div>
          )}
