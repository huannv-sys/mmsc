  ...
  const fetchBlockedIPs = async (deviceId: number) => {
    try {
      const { data } = await axios.get(
        `/api/security/blocked-ips?deviceId=${deviceId}`,
      );
          ...
          {status && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Suricata {status.version}</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="overview" className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  Hệ thống bảo mật mạng tích hợp sử dụng Suricata để phát hiện
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      <Button variant="outline" onClick={processAlerts}>
                        <RocketIcon className="mr-2 h-4 w-4" />
                        Xử lý cảnh báo
                      </Button>

                      <Button variant="outline" onClick={acknowledgeAllAlerts}>
