                        ...
                        <tr key={device.id} className="hover:bg-gray-700 cursor-pointer" onClick={() => {
                            ...
                            <div className="text-sm text-white">
                              {device.cpu ? (
                                <div className="w-16 bg-gray-700 rounded-full h-1.5">
                                  <div className="bg-blue-500 h-1.5 rounded-full" style={{ width: `${device.cpu}%` }}></div>
                                </div>
                              ) : (
                          ...
                          <td className="px-3 py-3 whitespace-nowrap">
                            <div className="text-sm text-white">
                              {device.totalMemory ? (
                                <div className="w-16 bg-gray-700 rounded-full h-1.5">
                                  <div className="bg-green-500 h-1.5 rounded-full" style={{ width: `${Math.round((parseInt(device.totalMemory) / 134217728) * 100)}%` }}></div>
                                </div>
                              ) : (
                                <span className="text-gray-400">N/A</span>
                              )}
                  ...
                  <div key={device.id} className="bg-gray-700 p-4 rounded-lg">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-xs text-white">{device.cpu ? `${device.cpu}%` : 'N/A'}</span>
                      </div>
                      <div className="w-full bg-gray-600 rounded-full h-1">
                        <div 
                          className="bg-blue-500 h-1 rounded-full" 
                          style={{ width: device.cpu ? `${device.cpu}%` : '0%' }}
                        ></div>
                      </div>
                      ...
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <span className="text-xs text-white">
                          {device.totalMemory ? `${Math.round((parseInt(device.totalMemory) / 134217728) * 100)}%` : 'N/A'}
                        </span>
                      </div>
                      <div className="w-full bg-gray-600 rounded-full h-1">
                        <div 
                          className="bg-green-500 h-1 rounded-full" 
                          style={{ width: device.totalMemory ? `${Math.round((parseInt(device.totalMemory) / 134217728) * 100)}%` : '0%' }}
                        ></div>
                      </div>
