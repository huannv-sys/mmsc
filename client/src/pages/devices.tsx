...
const DevicesPage = () => {
  ...
  const discoverMutation = useMutation({
    mutationFn: async (subnet: string) => {
      const response = await apiRequest("POST", "/api/devices/discover", {
        subnet,
      });
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Quét mạng để tìm thiết bị MikroTik. Nhập subnet để bắt đầu
                  quét.
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    <p className="text-xs text-gray-500">
                      Ví dụ: 192.168.1.0/24 sẽ quét từ 192.168.1.1 đến
                      192.168.1.254
                    </p>
                  </div>
                </div>
              ...
              >
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-start">
                    ...
                    <div
                      className={`px-2 py-1 text-xs font-medium rounded-full ${device.isOnline ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                    >
                ...
                <CardContent className="pb-2">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center text-sm">
                      ...
                      <span className="text-gray-700">
                        Cập nhật cuối: {formatLastSeen(device.lastSeen)}
                      </span>
                    </div>
                  </div>
                </CardContent>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm text-gray-500 mb-6 text-center max-w-md">
              Thêm thiết bị MikroTik đầu tiên của bạn để bắt đầu giám sát, hoặc
              sử dụng tính năng tìm kiếm tự động để tìm thiết bị trên mạng.
            </p>
